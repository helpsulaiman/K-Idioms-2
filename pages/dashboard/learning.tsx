        ...
        <Layout title="Manage Learning">
            <DashboardLayout>
                ...
                <div className="grid gap-4">
                    {lessons.map(lesson => (
                        <div key={lesson.id} className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 flex justify-between items-center">
                            <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button className="btn btn-sm btn-danger text-white" disabled>Delete</button>
                            </div>
                        </div>
                    ))}
                    {lessons.length === 0 && (
                        <p className="text-center text-gray-500 py-8">No lessons in this level yet.</p>
                    )}
                </div>
            </DashboardLayout>
        </Layout>
