-- ==========================================
-- FIXED SCHEMA & SEED SCRIPT
-- ==========================================

-- ⚠️ WARNING: This will reset the learning tables to ensure a clean structure.
-- It is necessary because the previous script might have left the database in a broken state.
...
CREATE TABLE lessons (
    id SERIAL PRIMARY KEY,
    level_id INTEGER REFERENCES levels(id) ON DELETE CASCADE, -- Fixed typo here (added space)
    title TEXT NOT NULL,
    description TEXT,
